                ...
                <div className="card mt-4" style={{ "width": "18rem", "maxHeight": "360px" }}>
                    ...
                    <div className="card-body">
                        ...
                        <div className='container w-100'>
                            <select className='h-100 btn-outline-danger rounded' onChange={(e) => setQty(e.target.value)}>
                            ...
                            <select className='m-2 h-100 btn-outline-danger rounded' ref={priceRef} onChange={(e) => setSize(e.target.value)}>
